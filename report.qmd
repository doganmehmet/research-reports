...
option_adjusted_spread = option_adjusted_spread.resample("M").last()
...
#     api_key=os.environ['DEEPSEEK_API_KEY'],  # Direct from environment
...
# ai_response_ds = response.choices[0].message.content
...
# --- Plot ---
fig, ax = plt.subplots()
bars = ax.bar(plot_data.index.to_timestamp(), plot_data['cpi'], color="#0612f2", width=20)
...
ax = plot_data.plot(kind='bar', color='#0612f2')
